      ...
      <div className={`bg-techno-white bg-opacity-5 w-[600px] h-[550px] m-auto rounded-[35px] backdrop-blur-[10px] flex flex-col text-white ${isScreenSmall ? '' : 'ml-[600px]'}`}>
        ...
        <form onSubmit={(e) => e.preventDefault()} className="flex flex-col items-center mt-10">
          ...
          <div className="mt-2 text-center">
            <button type="button" onClick={handleAddEmployee} className="bg-techno-gold p-2 px-6 rounded-[45px] w-[450px] h-[55px] mb-3 hover:bg-techno-dark-gold transition-colors text-xl font-bold">
              Add
            </button>
          </div>
        </form>
